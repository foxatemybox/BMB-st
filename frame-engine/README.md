# BADLOOM Manga Browser frame-engine channel

This directory is the authoritative public update channel for the independently updatable BMB 0.5 frame-analysis engine.

- Channel manifest: `frame-engine-channel.json`
- Stable bundles: `releases/<version>/badloom-frame-engine-<version>.zip`
